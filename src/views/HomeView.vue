...
<h1 class="mx-auto w-10/12 flex justify-end mt-20">MEET OUR CHARACTERS</h1>
...
<!---------------------family quest info------------------------------->
<div class="bg-yellow-300 flex justify-center flex-col items-center py-6 mt-20">  
...
<div class="container mx-auto w-10/12 pt-6">
    ...
    <!---------------------evening quest info------------------------------->
<div class="container mx-auto w-10/12 pt-6 flex flex-wrap mt-20">
  <div class="w-full">
    <h1>EVENING QUEST</h1>
  </div>
  <div class="w-full lg:w-6/12 flex flex-col justify-between py-6">
