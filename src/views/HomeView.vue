  ...
  <main>
    ...
    <div id="app">
      <div class="container-fantasyquest smalldevicesbackgroundpurple mx-auto w-10/12 flex flex-wrap">
        ...
        <div class="col w-3/12 flex justify-end items-end moon-background mt-16 hidden sm:flex" ref="moonBackground">
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-inner">
          <div class="card-front">
            <img src="@/assets/Havfruedronning.jpg" alt="Havfruedronning">
          </div>
          <div class="card-back">
            <h3 class="h3blue" style="font-size: 20px;">HAVFRUEDRONNING</h3>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-inner">
          <div class="card-front">
            <img src="@/assets/Malice.jpg" alt="Malice">
          </div>
          <div class="card-back">
            <h3 class="h3blue">MALICE</h3>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-inner">
          <div class="card-front">
            <img src="@/assets/Arkivaren_color_soft.jpg" alt="Arkivaren">
          </div>
          <div class="card-back">
            <h3 class="h3blue">ARKVIVAREN</h3>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-inner">
          <div class="card-front">
            <img src="@/assets/Gnist_color_Soft.jpg" alt="Gnist">
          </div>
          <div class="card-back">
            <h3 class="h3blue">GNIST</h3>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-inner">
          <div class="card-front">
            <img src="@/assets/Gygaz.jpg" alt="Gygaz">
          </div>
          <div class="card-back">
            <h3 class="h3blue">GYGAZ</h3>
          </div>
        </div>
      </div>
    </div>
